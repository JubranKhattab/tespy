...
class DropletSeparator(NodeBase):
    ...
    **Mandatory Equations**
    ...
    def case_one(self):
        ...
        self.outl[1].c_chemical = self.inl[0].c_chemical
        self.outl[0].C_chemical = self.inl[0].C_chemical
        self.outl[1].C_chemical = self.inl[0].C_chemical
        ...
        # fuel costs
        self.C_F = (self.inl[0].C_mech + self.inl[0].C_therm)
        ...
        self.outl[0].C_mech = self.c_P * self.outl[0].Ex_mech * unit_C
        self.outl[1].C_mech = self.c_P * self.outl[1].Ex_mech * unit_C
