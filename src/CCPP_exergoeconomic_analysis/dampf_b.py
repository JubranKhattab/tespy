...
c70 = Connection(dt5, 'out1', si_70, 'in1', label='70')  # b
...
c85 = Connection(hk1, 'out1', si_85, 'in1', label='85')  # b
...
# together?
nw.add_busses(g_p2, g_p3, g_dt1, g_dt2, g_dt3, g_dt4, g_dt5)
...
# fluids
c14.set_attr(m=850, p=1.051, T=644.51, fluid=exhaust_m)
