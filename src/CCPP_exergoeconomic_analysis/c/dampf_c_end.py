...
from tespy.components import (Source, Pump, Turbine, Sink, Valve, Merge, Splitter, HeatExchanger, Condenser, CycleCloser, HeatExchangerSimple)
...
# fluids
c14.set_attr(m=829.52, p=1.051, T=644.51, fluid=exhaust_m)
#c35.set_attr(p=24.750, T=50)
...
nw.del_conns(c85, c86, c87, c70, c34, c33)

c85 = Connection(hk1, 'out1', si_random_fw, 'in1', label='85')
c70 = Connection(dt5, 'out1', kon, 'in1', label='70')
c33 = Connection(p1, 'out1', si_random_kon, 'in1', label='33')
nw.add_conns(c85, c70, c33)
...
c85 = Connection(mix_fw1, 'out1', si_85, 'in1', label='85')
c80.set_attr(p=h_f.sat_p(c73.T.val+3))
c84.set_attr(p=h_f.sat_p(c72.T.val+3))
...
nw.del_conns(c33, c85)
c33 = Connection(p1, 'out1', vw, 'in2', label='33')
c85 = Connection(mix_fw1, 'out1', vw, 'in1', label='85')
c34 = Connection(vw, 'out2', si_random_kon, 'in1', label='34')
c86 = Connection(vw, 'out1', si_random_fw, 'in1', label='86')
nw.add_conns(c33, c85, c34, c86)
c33.set_attr(p=25)
vw.set_attr(pr1=0.99, pr2=0.99, ttd_l=10)
# ttd_l=10

# before merge to condenser
nw.del_conns(c86)
c86 = Connection(vw, 'out1', dr_be4, 'in1', label='86')
c87 = Connection(dr_be4, 'out1', si_87, 'in1', label='87')
c87.set_attr(p=h_f.sat_p(c93.T.val+5))
nw.add_conns(c86, c87)

# # with merge - after condenser
# nw.del_conns(c86, c32, c87)
# c86 = Connection(vw, 'out1', dr_be4, 'in1', label='86')
# c87 = Connection(dr_be4, 'out1', mix_kon, 'in1', label='87')
# c32m = Connection(kon, 'out1', mix_kon, 'in2', label='c32m')
# c32 = Connection(mix_kon, 'out1', p1, 'in1', label='32')
# #c87.set_attr(p=h_f.sat_p(c93.T.val+5))
# nw.add_conns(c86, c87, c32m, c32)

# with merge - before condenser
nw.del_conns(c70, c87)
c87 = Connection(dr_be4, 'out1', mix_kon, 'in1', label='87')
c70 = Connection(dt5, 'out1', mix_kon, 'in2', label='70')
c70m = Connection(mix_kon, 'out1', kon, 'in1', label='70m')
c70.set_attr(p=h_f.sat_p(c93.T.val+5))
c70m.set_attr(fluid0=water_m)
nw.add_conns(c87, c70, c70m)
...
# nw.del_conns(c35, c34)
# c35 = Connection(closer, 'out1', kvw, 'in2', label='35')
# c34 = Connection(vw, 'out2', closer, 'in1', label='34')
# nw.add_conns(c34, c35)
