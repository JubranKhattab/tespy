...
#split_to_sink = Connection(spl, 'out1', sink_spliter, 'in1', label='3')
split_to_tv1 = Connection(spl, 'out2', tv1, 'in1', label='7')
# sc_to_sink = Connection(sc, 'out1', sink_abgas, 'in1', label='12')
# tv1_to_sink = Connection(tv1, 'out1', sink_cooling, 'in1', label='8')
...
nw.add_conns(so_to_comp,comp_to_split, split_to_sc, sc_to_m_tit, split_to_tv1, tv1_to_m_tit, fuel_to_sc, m_tit_to_sink)
...
# # expander
# exp.set_attr(eta_s=0.90, pr=15)

# splitter
#split_to_tv1.set_attr(m=148.83)
m_tit_to_sink.set_attr(T=1380)
...
m_tit_to_sink.set_attr(fluid0={"O2": 0.001})
