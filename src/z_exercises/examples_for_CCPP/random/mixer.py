...
hot_valve = Connection(so_h_v, 'out1', mx, 'in1', label='82')
hot_turbine = Connection(so_h_t, 'out1', mx, 'in2', label='84')
...
# mixer
hot_valve.set_attr(m=46.45, T=90.01, p=0.704, fluid={'Water': 1})
hot_turbine.set_attr(m=30.49, T=144.00,  fluid={'Water': 1})
