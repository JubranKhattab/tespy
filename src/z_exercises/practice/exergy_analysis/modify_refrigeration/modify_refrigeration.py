...
# only for exporting results from dataframe to markdown
...
"""
---------------------------------------------------------------------------------------------------------------------------------------------------------------
Up to here it is as usual. A thermodynamic analysis was made and all results for the connections, components and buses were printed out. No exergy analysis yet
---------------------------------------------------------------------------------------------------------------------------------------------------------------
"""
...
"""
-----------------------------------------------------------------------------------------------------
This area is only about the export of the results and tables, not about the calculation and analysis.
START :
"""
# fmt = {
#     'latex_body': True,
...
"""
------------------------------------------------------------------------------------------------------------
Modify the dataframe so that the two fluids - Water and Air - have the same reference point for the enthalpy.
Start:
"""
