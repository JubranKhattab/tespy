...
""" here the cooler steam is not being used. Epsilon of the turbine component is the same but it ist smaller for the whole process (last table)"""
def main_func1():
        # network
        ...
        # loss
        cold_steam = Bus('Abgase')
        cold_steam.add_comps(
            {'comp': si})
        ...
        ean = ExergyAnalysis(turbine_nw, E_P=[power], E_F=[hot_steam], E_L=[cold_steam])
